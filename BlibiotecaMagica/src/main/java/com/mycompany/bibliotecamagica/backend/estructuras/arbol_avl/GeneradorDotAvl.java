...
public class GeneradorDotAvl {
    ...
    public String obtenerDot(NodoAvl<InfoLibro> raiz){
    ...
    private void agregarDatosRecursivos(NodoAvl<InfoLibro> nodo, StringBuilder datos) {
        String titulo = nodo.obtenerPrimero().getLibro().getSinGuiones();
